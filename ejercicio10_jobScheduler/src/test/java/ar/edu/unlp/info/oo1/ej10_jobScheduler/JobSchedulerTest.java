...
public class JobSchedulerTest {
    ...
    private JobScheduler newPriorityScheduler() {
    	HighestPriority hp = new HighestPriority("HighestPriority");
    	JobScheduler priorityScheduler = new JobScheduler(hp);
    	return priorityScheduler;
    }
    
    private JobScheduler newEffortScheduler() {
    	MostEffort me = new MostEffort("MostEffort");
    	JobScheduler effortScheduler = new JobScheduler(me);
    ...
    @Test
    void testSchedule() {
    	JobScheduler aScheduler = new JobScheduler(null);
